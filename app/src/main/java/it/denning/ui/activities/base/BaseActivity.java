...
import it.denning.ui.fragments.dialogs.base.ProgressDialogFragment;
...
import it.denning.utils.broadcasts.NetworkChangeReceiver;
import it.denning.utils.helpers.ActivityUIHelper;
import it.denning.utils.helpers.FirebaseAuthHelper;
import it.denning.utils.helpers.LoginHelper;
...
public abstract class BaseActivity extends AppCompatActivity implements ActionBarBridge, ConnectionBridge, LoadingBridge, SnackbarBridge {
    ...
    @Override
    public void showSnackbar(String title, int duration) {
        if (snackBarView != null) {
...
//                showSnackbar(R.string.error_disconnected, Snackbar.LENGTH_INDEFINITE, Priority.MAX);
    ...
    public void startPrivateChat(QBChatDialog dialog) {
