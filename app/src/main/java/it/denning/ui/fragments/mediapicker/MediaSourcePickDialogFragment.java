...
public class MediaSourcePickDialogFragment extends DialogFragment {
    ...
    private static final int DENNING_FILE = 4;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final boolean imageRequest = requestCode != MediaUtils.IMAGE_VIDEO_LOCATION_REQUEST_CODE && requestCode != MediaUtils.DENNING_FILE_REQUEST_CODE;
            ...
            public void onSelection(MaterialDialog materialDialog, View view, int i,
                ...
                switch (i) {
                    ...
                    case POSITION_LOCATION:
                        ...
                        break;
                    case DENNING_FILE:
                        onImageSourcePickedListener.onImageSourcePicked(ImageSource.DENNING_FILE);
                        break;
                }
            }
        });
            ...
            switch (source) {
                ...
                case DENNING_FILE:
                    if (fragment != null) {
                        Activity activity = fragment.getActivity();
                        setupActivityToBeNonLoggable(activity);
                        MediaUtils.startDenningFileForResult(fragment);
                    } else {
                        setupActivityToBeNonLoggable(activity);
                        MediaUtils.startDenningFileForResult(activity);
                    }
                    break;
            }
        }
