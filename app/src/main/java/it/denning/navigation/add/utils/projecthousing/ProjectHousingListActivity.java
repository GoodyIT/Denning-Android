...
import it.denning.navigation.add.utils.coramlist.CoramListAdapter;
...
public class ProjectHousingListActivity extends MySearchBaseActivity implements OnItemClickListener{
    private ProjectHousingListAdapter adapter;
    ...
    private void initFields() {
        toolbarTitle.setText(R.string.project_housing_title);

        setupRecyclerView();
    }

    private void setupRecyclerView() {
        adapter = new ProjectHousingListAdapter(new ArrayList<ProjectHousing>());
    ...
    private void setupSearchView() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                KeyboardUtils.hideKeyboard(ProjectHousingListActivity.this);
                searchData(query);
                return false;
            }
    ...
    private void manageResponse(JsonElement jsonElement) {
        ...
        ProjectHousing[] contacts = new Gson().fromJson(jsonElement, ProjectHousing[].class);
    ...
    private void loadData() {
        String url = DIConstants.PROPERTY_PROJECT_HOUSING_GET_URL + filter + "&page=" + page;
