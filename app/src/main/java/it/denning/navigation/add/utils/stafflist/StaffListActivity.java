package it.denning.navigation.add.utils.stafflist;
...
public class StaffListActivity extends MySearchBaseActivity implements OnItemClickListener{
    private int title;
    private String type;
    ...
    public static void start(Context context, int title, String type) {
    ...
    private void setupRecyclerView() {
        adapter = new StaffListAdapter(new ArrayList<StaffModel>());
    ...
    private void setupSearchView() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                KeyboardUtils.hideKeyboard(StaffListActivity.this);
                searchData(query);
                return false;
            }
    ...
    private void manageResponse(JsonElement jsonElement) {
        ...
        StaffModel[] contacts = new Gson().fromJson(jsonElement, StaffModel[].class);
    ...
    private void loadData() {
        String url = DIConstants.STAFF_GET_URL + type + "&search=" + filter + "&page=" + page;
