...
public class ListMatterAdapter extends SectioningAdapter {
    private OnItemClickListener itemClickListener;
    final private List<MatterCodeModel> matterCodes;

    public ListMatterAdapter(List<MatterCodeModel> matterCodes) {

        this.matterCodes = matterCodes;
    }
    
    public List<MatterCodeModel> getMatterCodes() {
        return matterCodes;
    }
    ...
    public void onBindItemViewHolder(SectioningAdapter.ItemViewHolder viewHolder, int sectionIndex, final int itemIndex, int itemType) {
        MatterCodeModel model = matterCodes.get(itemIndex);
        ItemViewHolder itemViewHolder = (ItemViewHolder) viewHolder;

        itemViewHolder.contactName.setText(model.code);
        itemViewHolder.contactID.setText(model.description);
    ...
    public void swapItems(List<MatterCodeModel> newmatterCodes) {
