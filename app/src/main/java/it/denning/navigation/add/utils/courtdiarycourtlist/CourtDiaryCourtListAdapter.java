...
public class CourtDiaryCourtListAdapter extends SectioningAdapter {
    private OnItemClickListener itemClickListener;
    final private List<CourtDiaryCourt> models;

    public CourtDiaryCourtListAdapter(List<CourtDiaryCourt> models) {

        this.models = models;
    }
    
    public List<CourtDiaryCourt> getModels() {
        return models;
    }
    ...
    public void onBindItemViewHolder(SectioningAdapter.ItemViewHolder viewHolder, int sectionIndex, final int itemIndex, int itemType) {
        CourtDiaryCourt model = models.get(itemIndex);
        ItemViewHolder itemViewHolder = (ItemViewHolder) viewHolder;

        itemViewHolder.contactName.setText(model.place);
        itemViewHolder.contactID.setText(model.typeE);
    ...
    public void swapItems(List<CourtDiaryCourt> newmodels) {
