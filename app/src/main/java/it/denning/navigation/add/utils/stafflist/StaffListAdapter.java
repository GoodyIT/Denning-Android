...
public class StaffListAdapter extends SectioningAdapter {
    private OnItemClickListener itemClickListener;
    final private List<StaffModel> models;

    public StaffListAdapter(List<StaffModel> models) {
    ...
    public void onBindItemViewHolder(SectioningAdapter.ItemViewHolder viewHolder, int sectionIndex, final int itemIndex, int itemType) {
        ...
        itemViewHolder.contactName.setText(model.nickName);
        itemViewHolder.contactID.setText(model.name);
    ...
    public void onBindHeaderViewHolder(SectioningAdapter.HeaderViewHolder viewHolder, int sectionIndex, int headerType) {
        ...
        headerViewHolder.nameTitle.setText("Nick Name");
