...
import it.denning.navigation.add.utils.branchlist.BranchListAdapter;
...
public class SolicitorListActivity extends MySearchBaseActivity implements OnItemClickListener{
    private int title;
    private SolicitorListAdapter adapter;
    ...
    public static void start(Context context, int title) {
        Intent intent = new Intent(context, SolicitorListActivity.class);
    ...
    private void setupRecyclerView() {
        adapter = new SolicitorListAdapter(new ArrayList<StaffModel>());
    ...
    private void setupSearchView() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                KeyboardUtils.hideKeyboard(SolicitorListActivity.this);
                searchData(query);
                return false;
            }
    ...
    private void manageResponse(JsonElement jsonElement) {
        ...
        StaffModel[] matterSimples = new Gson().fromJson(jsonElement, StaffModel[].class);
    ...
    private void loadData() {
        String url = DIConstants.CONTACT_SOLICITOR_GET_LIST_URL + filter + "&page=" + page;
