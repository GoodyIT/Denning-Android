...
public class MasterTitleListActivity extends MySearchBaseActivity implements OnItemClickListener{
    private MasterTitleListAdapter adapter;
    ...
    private void initFields() {
        toolbarTitle.setText(R.string.master_title);

        setupRecyclerView();
    }

    private void setupRecyclerView() {
        adapter = new MasterTitleListAdapter(new ArrayList<MasterTitle>());
    ...
    private void setupSearchView() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                KeyboardUtils.hideKeyboard(MasterTitleListActivity.this);
                searchData(query);
                return false;
            }
    ...
    private void manageResponse(JsonElement jsonElement) {
        ...
        MasterTitle[] contacts = new Gson().fromJson(jsonElement, MasterTitle[].class);
    ...
    private void loadData() {
        String url = DIConstants.PROPERTY_MASTER_TITLE_GETLIST_URL + filter + "&page=" + page;
