...
public class MatterLitigationActivity extends MySearchBaseActivity implements OnItemClickListener{
    private MatterLitigationAdapter adapter;
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, MatterLitigationActivity.class);
    ...
    private void initFields() {
        toolbarTitle.setText(R.string.matter_litigation_title);

        setupRecyclerView();
    }

    private void setupRecyclerView() {
        adapter = new MatterLitigationAdapter(new ArrayList<MatterLitigation>());
    ...
    private void setupSearchView() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                KeyboardUtils.hideKeyboard(MatterLitigationActivity.this);
                searchData(query);
                return false;
            }
    ...
    private void manageResponse(JsonElement jsonElement) {
        ...
        MatterLitigation[] matterSimples = new Gson().fromJson(jsonElement, MatterLitigation[].class);
    ...
    private void loadData() {
        String url = DIConstants.MATTER_LITIGATION_GET_LIST_URL + filter + "&page=" + page;
