...
public class CaseTypeListActivity extends MySearchBaseActivity implements OnItemClickListener{
    private CaseTypeListAdapter adapter;
    ...
    private void initFields() {
        toolbarTitle.setText(R.string.select_case_type_title);

        setupRecyclerView();
    }

    private void setupRecyclerView() {
        adapter = new CaseTypeListAdapter(new ArrayList<CaseType>());
    ...
    private void setupSearchView() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                KeyboardUtils.hideKeyboard(CaseTypeListActivity.this);
                searchData(query);
                return false;
            }
    ...
    private void manageResponse(JsonElement jsonElement) {
        ...
        CaseType[] contacts = new Gson().fromJson(jsonElement, CaseType[].class);
    ...
    private void loadData() {
        String url = DIConstants.CASE_TYPE_GET_LIST_URL + filter + "&page=" + page;
