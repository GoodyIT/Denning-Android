...
public class BranchListActivity extends MySearchBaseActivity implements OnItemClickListener{
    private int title;
    ...
    private void setupRecyclerView() {
        adapter = new BranchListAdapter(new ArrayList<BankBranchModel>());
    ...
    private void setupSearchView() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                KeyboardUtils.hideKeyboard(BranchListActivity.this);
                searchData(query);
                return false;
            }
    ...
    private void manageResponse(JsonElement jsonElement) {
        ...
        BankBranchModel[] matterSimples = new Gson().fromJson(jsonElement, BankBranchModel[].class);
    ...
    private void loadData() {
        String url = DIConstants.BANK_BRANCH_GET_LIST_URL + filter + "&page=" + page;
