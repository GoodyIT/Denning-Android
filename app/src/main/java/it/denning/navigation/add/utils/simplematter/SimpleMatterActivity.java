...
public class SimpleMatterActivity extends MySearchBaseActivity implements OnItemClickListener{
    private int title;
    private SimpleMatterAdapter adapter;
    ...
    public static void start(Context context, int title) {
        Intent intent = new Intent(context, SimpleMatterActivity.class);
    ...
    private void setupRecyclerView() {
        adapter = new SimpleMatterAdapter(new ArrayList<MatterSimple>());
    ...
    private void setupSearchView() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                KeyboardUtils.hideKeyboard(SimpleMatterActivity.this);
                searchData(query);
                return false;
            }
    ...
    private void manageResponse(JsonElement jsonElement) {
        ...
        MatterSimple[] matterSimples = new Gson().fromJson(jsonElement, MatterSimple[].class);
    ...
    private void loadData() {
        String url = DIConstants.MATTERSIMPLE_GET_URL + filter  + "&page=" + page;
    ...
    public void onClick(View view, int position) {
        ...
        DISharedPreferences.getInstance().selectedMatterSimple = adapter.getMatters().get(position);
