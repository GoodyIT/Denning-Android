package it.denning.navigation.add.utils.contactlist;
...
public class ContactListActivity extends MySearchBaseActivity implements OnItemClickListener{
    private int title;
    ...
    private void setupRecyclerView() {
        adapter = new ContactListAdapter(new ArrayList<StaffModel>());
    ...
    private void setupSearchView() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                KeyboardUtils.hideKeyboard(ContactListActivity.this);
                searchData(query);
                return false;
            }
    ...
    private void loadData() {
        String url = DIConstants.CONTACT_GETLIST_URL + filter + "&page=" + page;
