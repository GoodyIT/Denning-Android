package it.denning.navigation.add.utils.courtdiarycourtlist;
...
import it.denning.navigation.add.utils.contactlist.ContactListAdapter;
...
public class CourtDiaryCourtListActivity extends MySearchBaseActivity implements OnItemClickListener{
    private CourtDiaryCourtListAdapter adapter;
    ...
    private void setupRecyclerView() {
        adapter = new CourtDiaryCourtListAdapter(new ArrayList<CourtDiaryCourt>());
    ...
    private void setupSearchView() {
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                KeyboardUtils.hideKeyboard(CourtDiaryCourtListActivity.this);
                searchData(query);
                return false;
            }
    ...
    private void manageResponse(JsonElement jsonElement) {
        ...
        CourtDiaryCourt[] contacts = new Gson().fromJson(jsonElement, CourtDiaryCourt[].class);
    ...
    private void loadData() {
        String url = DIConstants.COURTDIARY_COURT_GET_LIST_URL + filter + "&page=" + page;
