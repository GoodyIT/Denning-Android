...
public class TaxInvoiceAdapter extends SectioningAdapter {
    private final List<TaxInvoiceModel> modelArrayList;
    private final Context mContext;
    private final OnItemClickListener clickListener;

    public TaxInvoiceAdapter(List<TaxInvoiceModel> modelArrayList, Context mContext, OnItemClickListener clickListener) {
