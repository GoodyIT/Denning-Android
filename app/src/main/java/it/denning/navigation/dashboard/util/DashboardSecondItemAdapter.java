...
public class DashboardSecondItemAdapter extends BaseAdapter {
    private final Context mContext;
    private final ArrayList<FirstItemModel> models;
    Point size;

    public DashboardSecondItemAdapter(Context mContext, ArrayList<FirstItemModel> models) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.dashboard_second_item, null);
            ...
            final RelativeLayout relativeLayout = (RelativeLayout)convertView.findViewById(R.id.second_item_layout);
            final ViewHolder viewHolder = new ViewHolder(titleTextView, valueTextView, tomorrowTextView, footerValueTextView, relativeLayout);
    ...
    private class ViewHolder {
        ...
        private ViewHolder(TextView title, TextView value, TextView tomorrow, MaterialBadgeTextView footerDescription, RelativeLayout relativeLayout) {
            this.title = title;
            this.value = value;
